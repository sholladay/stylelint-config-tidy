...
**Important work** comes in many forms. There are labels for [bugs](https://github.com/sholladay/stylelint-config-tidy/labels/bug) and [easy](https://github.com/sholladay/stylelint-config-tidy/labels/easy) vs [hard](https://github.com/sholladay/stylelint-config-tidy/labels/hard) tasks. We also appreciate documentation, examples, tutorials, blogs, videos, books, and other supporting content.
